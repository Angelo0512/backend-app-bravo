...
object SecurityConstants{
    ...
    const val TOKEN_LIFETIME: Long = 864000000 //This token lifetime can be change
    const val TOKEN_PREFIX = "Bearer "
    const val APPLICATION_JSON = "application/json"
    const val UTF_8 = "UTF-8"
    val TOKEN_SECRET: String = Base64.getEncoder().encodeToString("Bravo-Workshop".toByteArray())
}
