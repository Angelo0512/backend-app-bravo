...
/** Clients **/
INSERT INTO public.client (id ,email, name, telephone)
VALUES (1, 'jane@test.com','Jane Doe', 61234567);
INSERT INTO public.client (id ,email, name, telephone)
VALUES (2, 'bruce@test.com','Bruce Doe', 62234566);
INSERT INTO public.client (id ,email, name, telephone)
VALUES (3, 'dorothy@test.com','Dorothy Rowland', 62234555);


/** client_vehicle **/
INSERT INTO public.client_vehicle (client_id, vehicle_id) VALUES (1, 2);
INSERT INTO public.client_vehicle (client_id, vehicle_id) VALUES (2, 1);
INSERT INTO public.client_vehicle (client_id, vehicle_id) VALUES (3, 1);

/** technicians **/
INSERT INTO public.technician (id, user_id)
VALUES (1, 1);
