...
public final class Privilege {
    ...
    private java.util.Set<backend.workshop.User> userList;
    @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    public final backend.workshop.Privilege copy(@org.jetbrains.annotations.Nullable()
    java.lang.Long id, @org.jetbrains.annotations.NotNull()
    java.lang.String name, @org.jetbrains.annotations.NotNull()
    java.util.Set<backend.workshop.User> userList, @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.Set<backend.workshop.User> component3() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.Set<backend.workshop.User> getUserList() {
        return null;
    }
    
    public final void setUserList(@org.jetbrains.annotations.NotNull()
    java.util.Set<backend.workshop.User> p0) {
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.Set<backend.workshop.Role> component4() {
        return null;
    }
