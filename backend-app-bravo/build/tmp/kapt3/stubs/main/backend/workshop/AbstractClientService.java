...
public class AbstractClientService implements backend.workshop.ClientService {
    ...
    @java.lang.Override()
    public java.util.List<backend.workshop.ClientResult> findAll() {
        return null;
    }
    
    @org.jetbrains.annotations.Nullable()
    @java.lang.Override()
    public backend.workshop.ClientResult findById(long id) {
        return null;
    }
    
    @org.jetbrains.annotations.Nullable()
    @java.lang.Override()
    public backend.workshop.ClientResult create(@org.jetbrains.annotations.NotNull()
